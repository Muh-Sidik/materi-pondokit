    ...
    <div class="container">
        <table class="table table-bordered table-hover">
            ...
            <tbody class="text text-center">
                ...
                $list = new Crud();
                $statement = $list->list();
                $tampil = $statement->fetchAll(PDO::FETCH_ASSOC);
                ?>
                <?php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a type="button" class="btn btn-outline-danger" name="delete" href="delete.php?id=<?= $data['id']?>">Hapus</a>
                    </td>
