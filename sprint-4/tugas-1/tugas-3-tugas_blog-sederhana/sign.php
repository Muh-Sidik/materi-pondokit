...
<body>
    ...
    <div class="container">
        <h2 class="text-center">Menu Sign</h2>
        <hr>
        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <a type="button" class="btn btn-light" href="index.php">Home</a>
        </ul>
                ...
                <form method="POST" action="sign.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nomor" class="form-control" placeholder="Masukkan Nomor HP Anda" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Password</label>
